...
/**
 * Created: Sep 10, 2009 10:40:49 AM
 *
 * @author <a href="mailto:artur.hefczyc@tigase.org">Artur Hefczyc</a>
 * @version $Rev: 4 $
 */
public class ClusterTrafficMonitor extends TigaseMonitorLine {
	...
	public void update(String id, StatisticsProviderMBean servBean) {
		addValue(id, servBean.getClusterPacketsPerSec());
	}
	...
	public void connected(String id, StatisticsProviderMBean servBean) {
		float[] history = servBean.getCLPacketsPerSecHistory();
