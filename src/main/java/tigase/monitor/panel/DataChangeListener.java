...
public interface DataChangeListener
	...
	public static final String HEAP_EDEN_COLLECTION_USAGE_USED =
			HEAP_MEMORY_KEY + EDEN_KEY + COLLECTION_USAGE_KEY + USED_KEY;

	public static final String HEAP_EDEN_COLLECTION_USAGE_MAX =
			HEAP_MEMORY_KEY + EDEN_KEY + COLLECTION_USAGE_KEY + MAX_KEY;
	...
	public static final String HEAP_SURVIVOR_PEAK_USAGE_USED =
			HEAP_MEMORY_KEY + SURVIVOR_KEY + PEAK_USAGE_KEY + USED_KEY;

	public static final String HEAP_SURVIVOR_PEAK_USAGE_MAX = HEAP_MEMORY_KEY + SURVIVOR_KEY + PEAK_USAGE_KEY + MAX_KEY;

	public static final String HEAP_SURVIVOR_COLLECTION_USAGE_USED =
			HEAP_MEMORY_KEY + SURVIVOR_KEY + COLLECTION_USAGE_KEY + USED_KEY;

	public static final String HEAP_SURVIVOR_COLLECTION_USAGE_MAX =
			HEAP_MEMORY_KEY + SURVIVOR_KEY + COLLECTION_USAGE_KEY + MAX_KEY;
	...
	public static final String HEAP_OLD_COLLECTION_USAGE_USED =
			HEAP_MEMORY_KEY + OLD_KEY + COLLECTION_USAGE_KEY + USED_KEY;

	public static final String HEAP_OLD_COLLECTION_USAGE_MAX =
			HEAP_MEMORY_KEY + OLD_KEY + COLLECTION_USAGE_KEY + MAX_KEY;
